...
public class CameraActivity extends AppCompatActivity implements
    ...
    private void displayTips(){
        ...
        String tipsMsg = "Put an OMR Sheet on flat surface.<br><br>Please make sure the light on an " +
                "OMR Sheet is proper (not too bright, not too low)<br><br>And there is no shadow." +
    ...
    private void loadCorrectAnswers(){
        ...
        omrSheet = ViewModelProviders.of(this, new OMRSheetViewModelFactory
                (20, 0, 0)).get(OMRSheet.class);
    ...
    private CameraView.Callback mCallback
        ...
        public void displayToast(final String toastMessage, final int duration){
            CameraActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    final Toast t = Toast.makeText(CameraActivity.this,toastMessage,
                            Toast.LENGTH_SHORT);
                    t.show();
